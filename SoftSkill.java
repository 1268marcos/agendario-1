...
public class SoftSkill {
    ...
    @NonNull
    @ColumnInfo(name = "SoftSkillId")
    private int mId;

    @Nullable
    @ColumnInfo(name = "SoftSkillName")
    private String mName;
 ...
 //o nome do construtor da classe deve ser o mesmo nome da classe
    ...
    public String getLearningSituation() {
        return mLearningSituation;
    }

    public void setStyle(String LearningSituation) {
        mLearningSituation = LearningSituation;
    }
